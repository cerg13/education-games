...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'silero-tts': {
    id: 'silero-tts',
    name: 'Silero TTS (Russian)',
    requiresApiKey: true,
    defaultBaseUrl: 'https://console.kubn8n.store/api/v1/callmind/tts',
    icon: '/logos/silero.svg',
    voices: [
      { id: 'xenia', name: 'Ксения (HD)', language: 'ru', gender: 'female', description: 'Женский голос высокого качества' },
      { id: 'kseniya', name: 'Ксения', language: 'ru', gender: 'female', description: 'Женский голос' },
      { id: 'baya', name: 'Бая', language: 'ru', gender: 'female', description: 'Женский голос' },
      { id: 'aidar', name: 'Айдар', language: 'ru', gender: 'male', description: 'Мужской голос' },
      { id: 'eugene', name: 'Евгений', language: 'ru', gender: 'male', description: 'Мужской голос' },
    ],
    supportedFormats: ['mp3', 'wav', 'ogg'],
